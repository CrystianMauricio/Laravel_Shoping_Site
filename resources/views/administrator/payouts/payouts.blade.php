                    ...
                    <div class="modal-lg modal-dialog modal-dialog-centered modal-dialog-scrollable"role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="title">Checkout Goods
                                </h5>
                            </div>
                                    ...
                                    <form action="{{ route('payouts.store') }}" method="POST" enctype=“multipart/form-data>
                                        ...
                                        <table class="table">
                                                {{-- <div>
                                                    ...
                                                    <small>*Add Item Data</small>
                                                </div> --}}
                                                <div>
                                                    <label for="roundText">Transaction No</label>
                                                    <input type="hidden" name="payout_id" id="payout_id">
                                                    <input type="hidden" name="users_id" id="users_id" value="{{ Auth::user()->id}}">
                                                    <input type="text" name="no_transaksi" class="form-control round mt-1" placeholder="Example Transaction Number : 001" required>
                                                </div>
                                                <div class="row mt-2">
                                                    <div class="col-10">
