    ...
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" class="form-control form-control-xl" name="company" placeholder="Company" required>
                    <div class="form-control-icon">
                        <i class="bi bi-building"></i>
                    </div>
                </div>
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" class="form-control form-control-xl" name="location" placeholder="Location" required>
                    <div class="form-control-icon">
