...
Route::group(['middleware' => 'auth'], function() {
	...
	Route::get('administrator/barang/viewitem/{id}/data', 'BarangController@viewitem')->name('barang.viewitem');
	Route::get('administrator/barang/viewlist/{pos}', 'BarangController@uservistlist')->name('barang.uservistlist');
	// ------ DATA MEMBER ADMIN ----------
	...
	Route::get('administrator/member/delete/{id}/data', 'MemberController@destroy')->name('member.delete');
	Route::get('administrator/member/allow/{id}/allow', 'MemberController@allow')->name('member.allow');
